...
let minuteCutOff = 15;
let hourCutOff2 = 14;
let minuteCutOff2 = 26;
let now = moment().format(momentDateFormat);
/*let todayISO = moment().add(1, 'day').format(momentDateFormat);
let tomorrowISO = moment().add(2, 'day').format(momentDateFormat);*/
let todayISO = moment().format(momentDateFormat);
let tomorrowISO = moment().add(1, 'day').format(momentDateFormat);
    ...
    <div class="label-input-container">
        ...
        <label for="pickup-houston"> <span style="font-weight:600">My Fit Foods Houston</span>
            ...
            <div class="extra-info">
                <p>TKTKTKTK address, Houston TX 77001</p>
                <p>Store hours
                    <br>Monday - Thursday: 8am - 8pm
                    <br>Friday: 8am - 6pm
                    <br>Saturday: 9am - 5pm
                    <br>Sunday: 10am - 8pm </p>
                <p>Please place orders before 5:30pm for next-day pickup</p>
            </div>
        </label>
    </div>
    <div class="label-input-container">
...
function checkCutoffDailyALTERNATE(currentMoment) {
  const hours = Number(currentMoment.format("HH"));
  const minutes = Number(currentMoment.format('mm'));

  if (hours > hourCutOff2) {
    return todayISO;
  } else if (hours < hourCutOff2) {
    return now;
  } else if (hours == hourCutOff2) {
    if (minutes < minuteCutOff2 || minutes == minuteCutOff2) {
      return now;
    } else if (minutes > minuteCutOff) {
      return todayISO;
    }
